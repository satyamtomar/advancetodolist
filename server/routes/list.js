...
router.route('/fetchlist').get(fetchuser,evalid.validate("vfetchlist"),listss.fetchlist);

router.route("/addlist").post(fetchuser,evalid.validate("vaddlist"),listss.addlist)
